// Задача 6 - 9
// sort и map
// Получи массив имен(поле name) людей, отсортированных в зависимости от количества их
// друзей(поле friends)
...
function getFriendsQuanlity({ friends }) {
...
const getNamesSortedByFriendsCount = (array) => {
  ...
  return first
    .sort((a, b) => getFriendsQuanlity(a) - getFriendsQuanlity(b))
    .map(({ name }) => name);
};
